...
namespace MicaDemo.Pages
{
    ...
    public sealed partial class MicaPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            token = BackdropBrush.RegisterPropertyChangedCallback(BackdropMicaBrush.TintColorProperty, OnTintColorPropertyChanged);
            OnTintColorPropertyChanged(BackdropBrush, BackdropMicaBrush.TintColorProperty);
        ...
        protected override void OnNavigatedFrom(NavigationEventArgs e)
        {
            ...
            ThemeHelper.UISettingChanged -= OnUISettingChanged;
            BackdropBrush.UnregisterPropertyChangedCallback(BackdropMicaBrush.TintColorProperty, token);
        }
